...
/**
 * CaptureChargeRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     zipMoneyPHP
...
class CaptureChargeRequest implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 0.0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CaptureChargeRequest., must be bigger than or equal to 0.0.');
        }
