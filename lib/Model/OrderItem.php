...
class OrderItem implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['price'] < 0.0)) {
            $invalid_properties[] = "invalid value for 'price', must be bigger than or equal to 0.0.";
        }
    ...
    public function setPrice($price)
    {
        ...
        if ($price < 0.0) {
            throw new \InvalidArgumentException('invalid value for $price when calling OrderItem., must be bigger than or equal to 0.0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if ($quantity < 1.0) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderItem., must be bigger than or equal to 1.0.');
        }
