...
class Configuration
{
    ...
    protected $supportedEnvironments = [
        'sandbox'    => ['host' => 'https://sand.merchant-api.com/merchant'],
        'production' => ['host' => 'https://merchant-api.com/merchant'],
    ];
    ...
    /**
     * Seconds to wait before a retry. Multiplied by the attempt number, so
     * successive retries back off linearly.
     *
     * @var int
     */
     ...
     *
     * @param int Retry Interval Value
     */
